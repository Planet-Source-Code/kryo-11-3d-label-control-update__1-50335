...
Dim m_xOffset As Integer
Dim m_yOffset As Integer
...
Public Property Get X_Offset() As Integer
    X_Offset = m_xOffset
End Property

Public Property Let X_Offset(New_XOffset As Integer)
    m_xOffset = New_XOffset
    UserControl_Resize
    PropertyChanged "X_Offset"
End Property

Public Property Get Y_Offset() As Integer
    Y_Offset = m_yOffset
End Property

Public Property Let Y_Offset(New_YOffset As Integer)
    m_yOffset = New_YOffset
    UserControl_Resize
    PropertyChanged "Y_Offset"
End Property
...
Private Sub UserControl_Resize()
    ...
    Label1(1).Top = m_yOffset
    Label1(1).Left = m_xOffset
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    m_xOffset = PropBag.ReadProperty("X_Offset", m_def_xOffset)
    m_yOffset = PropBag.ReadProperty("Y_Offset", m_def_yOffset)
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("X_Offset", m_xOffset, m_def_xOffset)
    Call PropBag.WriteProperty("Y_Offset", m_yOffset, m_def_yOffset)
